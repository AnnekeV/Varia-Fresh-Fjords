...
if os.path.isfile(pathDataTemp + "Basal_melt/Basal_basin_monthly.csv"):
    ...
    if not os.path.isdir(pathDataTemp + "Basal_melt"):
        os.mkdir(pathDataTemp + "Basal_melt")

    df_Basal_basin_monthly.to_csv(pathDataTemp + "Basal_melt/Basal_basin_monthly.csv")
    df_Basal_GrIS_annual.to_csv(pathDataTemp + "Basal_melt/Basal_GrIS_annual.csv")